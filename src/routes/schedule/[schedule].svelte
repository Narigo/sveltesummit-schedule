<script lang="ts">
	...
	const timezones = [
		...
		{ value: -5 * 60, label: 'UTC-05:00 - New York City (EDT), Santiago (CLT)' },
		{ value: -4 * 60, label: 'UTC-04:00 - Buenos Aires (ART), São Paulo (BRT)' },
		{ value: -1 * 60, label: 'UTC-01:00 - Accra (GMT), Reykjavik (GMT)' },
		{ value: 0, label: 'UTC+00:00 - London (BST)' },
		{ value: 1 * 60, label: 'UTC+01:00 - Cairo (EET), Johannesburg (SAST), Paris (CEST)' },
		...
		{ value: 7 * 60, label: 'UTC+07:00 - Hong Kong (HKT), Perth (AWST), Singapore (SGT)' },
